  ...
  <div class="contract-page">
    ...
    <el-card shadow="never" style="margin-top: 12px">
      <div style="margin-bottom: 12px">
        <el-button type="primary" @click="handleAdd" v-permission="['contract:sign-income','contract:sign-expense']">新建合同</el-button>
      </div>
        ...
        <el-table-column label="操作" width="220" fixed="right">
          <template #default="{ row }">
            ...
            <el-button type="primary" link size="small" @click="handleEdit(row)"
              :disabled="row.status === 'pending' || row.status === 'approved'" v-permission="['contract:sign-income','contract:sign-expense']">编辑</el-button>
            <el-button type="danger" link size="small" @click="handleDelete(row)"
              v-if="row.status !== 'pending' && row.status !== 'approved'" v-permission="['contract:sign-income','contract:sign-expense']">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
