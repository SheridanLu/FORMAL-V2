<template>
  <div>
    <div style="margin-bottom: 12px">
      <el-button v-permission="'hr:entry-process'" type="primary" @click="openCreate">新建入职</el-button>
    </div>
    ...
    <el-table :data="tableData" v-loading="loading" stripe border>
      ...
      <el-table-column label="操作" width="160">
        <template #default="{ row }">
          <el-button v-permission="'hr:entry-process'" type="primary" link size="small" @click="handleEdit(row)">编辑</el-button>
          <el-button v-permission="'hr:entry-process'" type="danger" link size="small" @click="handleDelete(row)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
