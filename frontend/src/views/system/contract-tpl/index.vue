  ...
  <div class="contract-tpl-page">
    <el-card shadow="never">
      <div style="display: flex; justify-content: space-between; margin-bottom: 12px">
        ...
        <el-button type="primary" @click="handleAdd" v-permission="'contract:template-manage'">新建模板</el-button>
      </div>
      ...
      <el-table :data="tableData" v-loading="loading" stripe border>
        ...
        <el-table-column label="操作" width="280" fixed="right">
          <template #default="{ row }">
            <el-button type="primary" link size="small" @click="handleUploadVersion(row)" v-permission="'contract:template-manage'">上传版本</el-button>
            <el-button type="success" link size="small" @click="handleViewVersions(row)">版本列表</el-button>
            <el-button type="warning" link size="small" @click="handleEdit(row)" v-permission="'contract:template-manage'">编辑</el-button>
            <el-button type="info" link size="small" @click="handleAuditLog(row)">日志</el-button>
            <el-button type="danger" link size="small" @click="handleDelete(row)" v-permission="'contract:template-manage'">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog v-model="versionsVisible" title="版本列表" width="750px">
      <el-table :data="versions" stripe border>
        ...
        <el-table-column label="操作" width="280">
          <template #default="{ row }">
            <el-button v-if="row.status !== 1" type="success" link size="small" @click="toggleVersion(row, 1)" v-permission="'contract:template-manage'">启用</el-button>
            <el-button v-else type="warning" link size="small" @click="toggleVersion(row, 0)" v-permission="'contract:template-manage'">停用</el-button>
            <el-button v-if="row.status !== 1" type="primary" link size="small" @click="handleSubmitApproval(row)" v-permission="'contract:template-manage'">提交审批</el-button>
