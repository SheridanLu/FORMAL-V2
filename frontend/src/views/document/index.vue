<template>
  <div class="page-container">
    <page-header title="文档管理">
      <el-button type="primary" v-permission="['doc:upload','doc:download','doc:manage']" @click="uploadVisible = true"><el-icon><Upload /></el-icon>上传文档</el-button>
    </page-header>
    ...
    <el-table v-loading="loading" :data="tableData" border stripe>
      ...
      <el-table-column label="操作" width="150" fixed="right">
        <template #default="{ row }">
          <el-button v-permission="['doc:upload','doc:download','doc:manage']" link type="primary" @click="handleDownload(row)">下载</el-button>
          <el-button v-permission="['doc:upload','doc:download','doc:manage']" link type="danger" @click="handleDelete(row)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
